// ISO 3166-1 numeric -> alpha-3 lookup, covering every numeric id used by the
// Natural Earth country topology (packages/ui/data/geo/countries-10m.json).
// This is separate from lib/geo-metadata.ts, whose country list is generated
// from the bundled subdivisions dataset and only covers a curated subset of
// countries — it cannot resolve a code for most of the world's countries.
const ISO_NUMERIC_TO_ALPHA3: Record<string, string> = {
  ...
  '124': 'CAN', '132': 'CPV', '136': 'CYM', '140': 'CAF', '144': 'LKA',
  ...
  '238': 'FLK', '239': 'SGS', '242': 'FJI', '246': 'FIN', '248': 'ALA',
  '250': 'FRA', '258': 'PYF', '260': 'ATF', '262': 'DJI', '266': 'GAB',
  ...
  '624': 'GNB', '626': 'TLS', '630': 'PRI', '634': 'QAT', '642': 'ROU',
  '643': 'RUS', '646': 'RWA', '652': 'BLM', '654': 'SHN', '659': 'KNA',
  '660': 'AIA', '662': 'LCA', '663': 'MAF', '666': 'SPM', '670': 'VCT',
...
export function getAlpha3FromNumericId(numericId: string): string | undefined {
